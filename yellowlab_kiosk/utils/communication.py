...
FLASK_SERVER_URL = "http://192.168.0.76:5000/upload"
# 저장할 경로 (원하는 경로로 변경)
TARGET_DIR = "/home/kang/aris-repo-5/aris-repo-5/yellowlab_kiosk_new/images/caricature"
    ...
    def run(self):
        ...
        if self.image_paths:
            for info in st.session_state.order_info:
                if info[2] == True:
                    files[f'image{image_counter}'] = open(f'/home/kang/aris-repo-5/aris-repo-5/yellowlab_kiosk_new/images/caricatures/original_{image_counter}.jpg','rb')
                    image_counter += 1
        ...
        if self.image_paths:
            ...
            if response.status_code == 200:
                ...
                for key, value in response_data.items():
                    ...
                    target_path = os.path.join(TARGET_DIR, f'received_{key}.jpg')
